...
class Honey(Wallet):
    ...
    def swap(self, retry=0):
        try:
            ...
            old_balance = self.get_balance(chain_name='berachain', token_name='HONEY', human=True)
            ...
            if self.wait_balance(chain_name='berachain', token_name='HONEY', needed_balance=old_balance, only_more=True) == 'not updated':
